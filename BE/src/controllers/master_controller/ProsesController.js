...
const createProses = async (req, res) => {
  ...
  try {
    ...
    const io = getIO();
    io.emit("proses_created", "Proses successfully created");
...
const updateProses = async (req, res) => {
  ...
  try {
    ...
    const io = getIO();
    io.emit("proses_updated", "Proses successfully updated");
...
const deleteProses = async (req, res) => {
  ...
  try {
    await model.deleteProses(id);
    const io = getIO();
    io.emit("proses_deleted", "Proses successfully deleted");
