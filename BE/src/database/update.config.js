...
const dbPaths = {
  data: {
    primary: "T:\\DBASE\\dbTemp\\dbData.mdb",
    fallback:
      "\\\\192.168.9.251\\padaprima\\DBASE\\RSUD. KABUPATEN\\DBASE\\dbTemp\\dbData.mdb",
  },
  qty: {
    primary: "T:\\DBASE\\dbTemp\\dbQty.mdb",
    fallback:
      "\\\\192.168.9.251\\padaprima\\DBASE\\RSUD. KABUPATEN\\DBASE\\dbTemp\\dbQty.mdb",
  },
  realQty: {
    primary: "T:\\DBASE\\dbQty.mdb",
    fallback:
      "\\\\192.168.9.251\\padaprima\\DBASE\\RSUD. KABUPATEN\\DBASE\\dbQty.mdb",
  },
  kcp: {
    primary: "T:\\DBASE\\dbDataKcp.mdb",
    fallback:
