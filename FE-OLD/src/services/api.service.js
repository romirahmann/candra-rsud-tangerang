...
if (hostname.startsWith("192.168.9.")) {
  dynamicBaseAPI = "http://192.168.9.192:3008/api";
  dynamicBaseURL = "http://192.168.9.192:3008";
} else if (hostname.startsWith("192.168.10.")) {
  dynamicBaseAPI = "http://192.168.10.192:3008/api";
  dynamicBaseURL = "http://192.168.10.192:3008";
} else if (hostname === "localhost" || hostname === "127.0.0.1") {
  dynamicBaseAPI = "http://localhost:3008/api";
  dynamicBaseURL = "http://localhost:3008";
} else {
  dynamicBaseAPI = "http://192.168.10.2:3008/api";
}
